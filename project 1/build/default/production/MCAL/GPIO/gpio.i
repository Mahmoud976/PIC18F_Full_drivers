...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t *_pin_config,direction_t *direction_status){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if (((void*)0)==_pin_config || _pin_config->pin > 8 -1 || _pin_config->port > 5 -1 || ((void*)0)==direction_status)
    ret=(Std_ReturnType)0x01;
    else
    {
...
Std_ReturnType gpio_pin_read_logic(const pin_config_t *_pin_config,logic_t *logic){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if (((void*)0)==_pin_config || _pin_config->pin > 8 -1 ||
        _pin_config->port > 5 -1 || ((void*)0)==logic )
    ret=(Std_ReturnType)0x01;
    else
    {
...
# 192 "MCAL/GPIO/gpio.c"
Std_ReturnType gpio_port_write_logic(port_index_t port,uint8 logic){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if (port > 5 -1||logic > 0xFF)
    ret=(Std_ReturnType)0x01;
    else
    {

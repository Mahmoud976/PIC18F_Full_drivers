...
# 12 "MCAL/ADC/adc_cfg.h"
# 1 "MCAL/ADC/../Interrupt/Internal_Interrupt.h" 1
# 12 "MCAL/ADC/../Interrupt/Internal_Interrupt.h"
# 1 "MCAL/ADC/../Interrupt/Interrupt_cfg.h" 1
# 12 "MCAL/ADC/../Interrupt/Interrupt_cfg.h"
# 1 "MCAL/ADC/../Interrupt/../../Utilities/Registers/registers.h" 1
# 15 "MCAL/ADC/../Interrupt/../../Utilities/Registers/registers.h"
# 1 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/types_t.h" 1
# 11 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/types_t.h"
# 1 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 1
# 10 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h"
...
# 10 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 2
# 11 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/types_t.h" 2

# 1 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/../std_Library/libraries.h" 1
# 10 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/../std_Library/libraries.h"
...
# 10 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/../std_Library/libraries.h" 2


# 1 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 1
# 12 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/../std_Library/libraries.h" 2
# 12 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 2
...
# 43 "MCAL/ADC/../Interrupt/../../Utilities/Registers/../types/../std_Library/../types/types_t.h"
uint32_t _XTAL_FREQ=8000000;
# 15 "MCAL/ADC/../Interrupt/../../Utilities/Registers/registers.h" 2
# 12 "MCAL/ADC/../Interrupt/Interrupt_cfg.h" 2

# 1 "MCAL/ADC/../Interrupt/../DIO_Driver/dio.h" 1
# 13 "MCAL/ADC/../Interrupt/../DIO_Driver/dio.h"
# 1 "MCAL/ADC/../Interrupt/../DIO_Driver/dio_cfg.h" 1
# 13 "MCAL/ADC/../Interrupt/../DIO_Driver/dio.h" 2
# 46 "MCAL/ADC/../Interrupt/../DIO_Driver/dio.h"
typedef enum{
    DIO_OUTPUT=0,
    DIO_INPUT
}direction_t;
...
# 13 "MCAL/ADC/../Interrupt/Interrupt_cfg.h" 2
# 52 "MCAL/ADC/../Interrupt/Interrupt_cfg.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY=0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority;
# 12 "MCAL/ADC/../Interrupt/Internal_Interrupt.h" 2
# 113 "MCAL/ADC/../Interrupt/Internal_Interrupt.h"
typedef enum{
    LOW=0,
    HIGH
...
static __attribute__((inline)) void select_result_format(uint8_t format);
static __attribute__((inline)) void adc_input(Channels_Selected channel);
static __attribute__((inline)) void select_voltage(uint8_t voltage);
# 53 "MCAL/ADC/adc.c"
Std_ReturnType ADC_Init(void (*ADC)(void),interrupt_priority priority,Acquisition_Time time,Conversion_Clock cycle ,Channels_Selected channel,uint8_t format,uint8_t voltage){
   Std_ReturnType ret=(Std_ReturnType)0x01;
    if(((void*)0) == ADC)ret = (Std_ReturnType)0x00;

    (*((volatile uint8_t *)0xFC2) &= ~((uint8_t)0x01 << 0));
    ...
    ((*((volatile uint8_t *)0xF9D) |= ((uint8_t)0x01 << 6)));

    ((*((volatile uint8_t *)0xFD0) |= ((uint8_t)0x01 << 7)));
    ((*((volatile uint8_t *)0xF9D) |= ((uint8_t)0x01 << 6)));
    if(priority==INTERRUPT_HIGH_PRIORITY)
        ((*((volatile uint8_t *)0xF9F) |= ((uint8_t)0x01 << 6)));
    else if(priority==INTERRUPT_LOW_PRIORITY)
        ((*((volatile uint8_t *)0xF9F) &= ~((uint8_t)0x01 << 6)));

    ((*((volatile uint8_t *)0xF9E) &= ~((uint8_t)0x01 << 6)));
...
Std_ReturnType ADC_Start_Conversion(){
    (*((volatile uint8_t *)0xFC2) |= ((uint8_t)0x01 << 1));
    return (Std_ReturnType)0x01;
}

Std_ReturnType ADC_Conversion_done(uint8_t * status){
   Std_ReturnType ret=(Std_ReturnType)0x01;
   if(((void*)0)==status)ret= (Std_ReturnType)0x00;
   else{
...
Std_ReturnType ADC_Get_Result(uint8_t format, uint16_t *result){
 Std_ReturnType ret =(Std_ReturnType)0x01;
  if(((void*)0)== result) ret = (Std_ReturnType)0x00;
  else {
      if(1==format){
          * result=(uint16_t)((*((volatile uint8_t *)0xFC4)<<8)+(*((volatile uint8_t *)0xFC3)));
      }
      else{* result=(uint16_t)(((*((volatile uint8_t *)0xFC4)<<8)+(*((volatile uint8_t *)0xFC3)))>>6);}
...
static __attribute__((inline)) void select_result_format(uint8_t format){
    if(format)(*((volatile uint8_t *)0xFC0) |= ((uint8_t)0x01 << 7));
    else (*((volatile uint8_t *)0xFC0) &= ~((uint8_t)0x01 << 7));

}

static __attribute__((inline)) void select_voltage(uint8_t voltage){
    if(voltage){(*((volatile uint8_t *)0xFC1) |= ((uint8_t)0x01 << 5));(*((volatile uint8_t *)0xFC1) |= ((uint8_t)0x01 << 4));}
    else {(*((volatile uint8_t *)0xFC1) &= ~((uint8_t)0x01 << 5));(*((volatile uint8_t *)0xFC1) &= ~((uint8_t)0x01 << 4));}

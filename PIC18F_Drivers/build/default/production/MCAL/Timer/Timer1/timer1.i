...
# 2 "<built-in>" 2
# 1 "MCAL/Timer/Timer1/timer1.c" 2
...
# 1 "MCAL/Timer/Timer1/timer1.h" 1
# 14 "MCAL/Timer/Timer1/timer1.h"
# 1 "MCAL/Timer/Timer1/../../../Utilities/Registers/registers.h" 1
# 15 "MCAL/Timer/Timer1/../../../Utilities/Registers/registers.h"
# 1 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/types_t.h" 1
# 11 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/types_t.h"
# 1 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 1
# 10 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h"
...
# 10 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 2
# 11 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/types_t.h" 2

# 1 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/../std_Library/libraries.h" 1
# 10 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/../std_Library/libraries.h"
...
# 10 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/../std_Library/libraries.h" 2


# 1 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 1
# 12 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/../std_Library/libraries.h" 2
# 12 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 2
...
# 43 "MCAL/Timer/Timer1/../../../Utilities/Registers/../types/../std_Library/../types/types_t.h"
uint32_t _XTAL_FREQ=8000000;
# 15 "MCAL/Timer/Timer1/../../../Utilities/Registers/registers.h" 2
# 14 "MCAL/Timer/Timer1/timer1.h" 2

# 1 "MCAL/Timer/Timer1/../../Interrupt/Internal_Interrupt.h" 1
# 12 "MCAL/Timer/Timer1/../../Interrupt/Internal_Interrupt.h"
# 1 "MCAL/Timer/Timer1/../../Interrupt/Interrupt_cfg.h" 1
# 13 "MCAL/Timer/Timer1/../../Interrupt/Interrupt_cfg.h"
# 1 "MCAL/Timer/Timer1/../../Interrupt/../DIO_Driver/dio.h" 1
# 13 "MCAL/Timer/Timer1/../../Interrupt/../DIO_Driver/dio.h"
# 1 "MCAL/Timer/Timer1/../../Interrupt/../DIO_Driver/dio_cfg.h" 1
# 13 "MCAL/Timer/Timer1/../../Interrupt/../DIO_Driver/dio.h" 2
# 46 "MCAL/Timer/Timer1/../../Interrupt/../DIO_Driver/dio.h"
typedef enum{
    DIO_OUTPUT=0,
    DIO_INPUT
}direction_t;
...
# 13 "MCAL/Timer/Timer1/../../Interrupt/Interrupt_cfg.h" 2
# 52 "MCAL/Timer/Timer1/../../Interrupt/Interrupt_cfg.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY=0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority;
# 12 "MCAL/Timer/Timer1/../../Interrupt/Internal_Interrupt.h" 2
# 113 "MCAL/Timer/Timer1/../../Interrupt/Internal_Interrupt.h"
typedef enum{
    LOW=0,
    HIGH
...
# 15 "MCAL/Timer/Timer1/timer1.h" 2
...
# 7 "MCAL/Timer/Timer1/timer1.c" 2

static __attribute__((inline)) void Timer1_Select_Mode(uint8_t Timer1_mode,uint8_t ASY);
static __attribute__((inline)) void Timer1_Select_Prescaler(timer1_prescaler_select_t prescaler);
static __attribute__((inline)) void Timer1_Select_Oscillator(uint8_t Oscillator);
# 40 "MCAL/Timer/Timer1/timer1.c"
Std_ReturnType Timer1_Write_Value(uint16_t value){
    *((volatile uint8_t *)0xFCF)=(value)>>8;
    *((volatile uint8_t *)0xFCE)=(uint8_t)(value);
...
Std_ReturnType Timer1_Read_Value(uint16_t * value){
    ...
    tmr1l=*((volatile uint8_t *)0xFCE);
    tmr1h=*((volatile uint8_t *)0xFCF);
...
Std_ReturnType Timer1_Init(void (*TIMER1)(void),interrupt_priority priority,uint8_t Oscillator,uint8_t Timer1_mode,uint8_t ASY,uint16_t Preload,timer1_prescaler_select_t prescaler){
    if(((void*)0)==TIMER1)return (Std_ReturnType)0x00;
    else{
    ...
    *((volatile uint8_t *)0xFCF)=((Preload)>>8);
    *((volatile uint8_t *)0xFCE)=(uint8_t)(Preload);

    extern uint16_t Timer1_Preload;
    Timer1_Preload=Preload;

    T1CONBIT.T1CKPS=prescaler;


    ((*((volatile uint8_t *)0xFF2) |= ((uint8_t)0x01 << 7)));
    ((*((volatile uint8_t *)0xF9D) |= ((uint8_t)0x01 << 0)));

    ((*((volatile uint8_t *)0xFD0) |= ((uint8_t)0x01 << 7)));
    if(priority==INTERRUPT_HIGH_PRIORITY)
        ((*((volatile uint8_t *)0xF9F) |= ((uint8_t)0x01 << 0)));
    else if(priority==INTERRUPT_LOW_PRIORITY)
        ((*((volatile uint8_t *)0xF9F) &= ~((uint8_t)0x01 << 0)));
    else{ }

    ((*((volatile uint8_t *)0xF9E) &= ~((uint8_t)0x01 << 0)));
...
static __attribute__((inline)) void Timer1_Select_Mode(uint8_t Timer1_mode,uint8_t ASY){
    ...
    else if(0x01==Timer1_mode){
        (T1CONBIT.TMR1CS=1);
        if(1==ASY){ (T1CONBIT.T1SYNC=0);}
        else if(0==ASY){(T1CONBIT.T1SYNC=1);}
        else{ }
    }
    else{ }
}
static __attribute__((inline)) void Timer1_Select_Oscillator(uint8_t Oscillator){
    if(0x00==Oscillator)(T1CONBIT.T1OSCEN=0);


    else if(0x01==Oscillator)
       (T1CONBIT.T1OSCEN=1);

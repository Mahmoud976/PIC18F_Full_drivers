...
# 2 "<built-in>" 2
# 1 "MCAL/Timer/Timer0/timer0.c" 2
...
# 1 "MCAL/Timer/Timer0/timer0.h" 1
# 15 "MCAL/Timer/Timer0/timer0.h"
# 1 "MCAL/Timer/Timer0/../../../Utilities/Registers/registers.h" 1
# 15 "MCAL/Timer/Timer0/../../../Utilities/Registers/registers.h"
# 1 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/types_t.h" 1
# 11 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/types_t.h"
# 1 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 1
# 10 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h"
...
# 10 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 2
# 11 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/types_t.h" 2

# 1 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/../std_Library/libraries.h" 1
# 10 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/../std_Library/libraries.h"
...
# 10 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/../std_Library/libraries.h" 2


# 1 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 1
# 12 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/../std_Library/libraries.h" 2
# 12 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 2
...
# 43 "MCAL/Timer/Timer0/../../../Utilities/Registers/../types/../std_Library/../types/types_t.h"
uint32_t _XTAL_FREQ=8000000;
# 15 "MCAL/Timer/Timer0/../../../Utilities/Registers/registers.h" 2
# 15 "MCAL/Timer/Timer0/timer0.h" 2

# 1 "MCAL/Timer/Timer0/../../Interrupt/Internal_Interrupt.h" 1
# 12 "MCAL/Timer/Timer0/../../Interrupt/Internal_Interrupt.h"
# 1 "MCAL/Timer/Timer0/../../Interrupt/Interrupt_cfg.h" 1
# 13 "MCAL/Timer/Timer0/../../Interrupt/Interrupt_cfg.h"
# 1 "MCAL/Timer/Timer0/../../Interrupt/../DIO_Driver/dio.h" 1
# 13 "MCAL/Timer/Timer0/../../Interrupt/../DIO_Driver/dio.h"
# 1 "MCAL/Timer/Timer0/../../Interrupt/../DIO_Driver/dio_cfg.h" 1
# 13 "MCAL/Timer/Timer0/../../Interrupt/../DIO_Driver/dio.h" 2
# 46 "MCAL/Timer/Timer0/../../Interrupt/../DIO_Driver/dio.h"
typedef enum{
    DIO_OUTPUT=0,
    DIO_INPUT
}direction_t;
...
# 13 "MCAL/Timer/Timer0/../../Interrupt/Interrupt_cfg.h" 2
# 52 "MCAL/Timer/Timer0/../../Interrupt/Interrupt_cfg.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY=0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority;
# 12 "MCAL/Timer/Timer0/../../Interrupt/Internal_Interrupt.h" 2
# 113 "MCAL/Timer/Timer0/../../Interrupt/Internal_Interrupt.h"
typedef enum{
    LOW=0,
    HIGH
...
# 16 "MCAL/Timer/Timer0/timer0.h" 2
# 28 "MCAL/Timer/Timer0/timer0.h"
typedef enum{
...
# 7 "MCAL/Timer/Timer0/timer0.c" 2

static __attribute__((inline)) void Timer0_Select_Size(uint8_t size);
static __attribute__((inline)) void Timer0_Select_Mode(uint8_t Timer0_mode,uint16_t Preload);
static __attribute__((inline)) void Timer0_Select_Edge(uint8_t TMR0_Counter_edge);
static __attribute__((inline)) void Timer0_Select_Prescaler(uint8_t Pre_Enable,timer0_prescaler_select_t prescaler);
# 37 "MCAL/Timer/Timer0/timer0.c"
Std_ReturnType Timer0_Write_Value(uint16_t value){
    *((volatile uint8_t *)0xFD7)=(value)>>8;
    *((volatile uint8_t *)0xFD6)=(uint8_t)(value);
...
Std_ReturnType Timer0_Read_Value(uint16_t * value){
    ...
    tmr0l=*((volatile uint8_t *)0xFD6);
    tmr0h=*((volatile uint8_t *)0xFD7);
...
Std_ReturnType Timer0_Init(void (*TIMER0)(void),interrupt_priority priority,uint8_t size ,uint8_t Timer0_mode,uint16_t Preload,uint8_t TMR0_Counter_edge,uint8_t Pre_Enable,timer0_prescaler_select_t prescaler){
    if(((void*)0)==TIMER0)return (Std_ReturnType)0x00;
    (T0CONBIT.TMR0ON=0);
    ...
    ((*((volatile uint8_t *)0xFF2) |= ((uint8_t)0x01 << 7)));
    ((*((volatile uint8_t *)0xFF2) |= ((uint8_t)0x01 << 5)));

    ((*((volatile uint8_t *)0xFD0) |= ((uint8_t)0x01 << 7)));
    if(priority==INTERRUPT_HIGH_PRIORITY)
        ((*((volatile uint8_t *)0xFF1) |= ((uint8_t)0x01 << 2)));
    else if(priority==INTERRUPT_LOW_PRIORITY)
        ((*((volatile uint8_t *)0xFF1) &= ~((uint8_t)0x01 << 2)));
    else{ }

    ((*((volatile uint8_t *)0xFF2) &= ~((uint8_t)0x01 << 2)));
...
static __attribute__((inline)) void Timer0_Select_Size(uint8_t size){
    if(8==size){(T0CONBIT.T08BIT=1);}
    else if(16==size){(T0CONBIT.T08BIT=0);}
    else { }
}
...
static __attribute__((inline)) void Timer0_Select_Mode(uint8_t Timer0_mode,uint16_t Preload){
    if(0x00==Timer0_mode){
        (T0CONBIT.T0CS=0);
        *((volatile uint8_t *)0xFD7)=(Preload)>>8;
        *((volatile uint8_t *)0xFD6)=(uint8_t)Preload;

    }
    else if(0x01==Timer0_mode){(T0CONBIT.T0CS=1);}
    else{ }
}
static __attribute__((inline)) void Timer0_Select_Edge(uint8_t TMR0_Counter_edge){
    if(0x01==TMR0_Counter_edge){(T0CONBIT.T0SE=1);}
    else if(0x00,TMR0_Counter_edge){(T0CONBIT.T0SE=0);}
    else{ }
}
...
static __attribute__((inline)) void Timer0_Select_Prescaler(uint8_t Pre_Enable,timer0_prescaler_select_t prescaler){
    ...
    else if(0==Pre_Enable){(T0CONBIT.PSA=1);}
    else { }
}

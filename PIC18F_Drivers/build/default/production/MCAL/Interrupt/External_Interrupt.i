...
void RB7_ISR_High();
void RB7_ISR_Low();
# 9 "MCAL/Interrupt/External_Interrupt.c" 2
...
Std_ReturnType Interrupt_INTx_Init(INTx_NUM num,INTx_edge edge,interrupt_priority priority){
    ...
    if( ((*((volatile uint8_t *)0xFF2) |= ((uint8_t)0x01 << BIT7))) && ((*((volatile uint8_t *)0xFF2) |= ((uint8_t)0x01 << BIT6)))){
        switch(num){
            case INTERRUPT_EXTERNAL_INT0:
                dio_pin_direction_initialize(INTERRUPT_EXTERNAL_INT0,'B',1);
                if(edge==INTERRUPT_FALLING_EDGE)
                  (*((volatile uint8_t *)0xFF1) &= ~((uint8_t)0x01 << BIT6));

                else if(edge==INTERRUPT_RAISING_EDGE)
                    (*((volatile uint8_t *)0xFF1) |= ((uint8_t)0x01 << BIT6));

                else ret=(Std_ReturnType)0x00;
                 (*((volatile uint8_t *)0xFF2) |= ((uint8_t)0x01 << BIT4));
                break;

            case INTERRUPT_EXTERNAL_INT1:

                (*((volatile uint8_t *)0xFF0) |= ((uint8_t)0x01 << BIT3));
                dio_pin_direction_initialize(INTERRUPT_EXTERNAL_INT1,'B',1);
                if(edge==INTERRUPT_FALLING_EDGE){
                    (*((volatile uint8_t *)0xFF1) &= ~((uint8_t)0x01 << BIT5));
            ...
            case INTERRUPT_EXTERNAL_INT2:
                ...
                (*((volatile uint8_t *)0xFF0) |= ((uint8_t)0x01 << BIT4));
                dio_pin_direction_initialize(INTERRUPT_EXTERNAL_INT2,'B',1);
                if(edge==INTERRUPT_FALLING_EDGE){
                    (*((volatile uint8_t *)0xFF1) &= ~((uint8_t)0x01 << BIT4));
...
static Std_ReturnType Init_Priority_INTx(INTx_NUM num,interrupt_priority priority){
    ...
    Std_ReturnType ret=((*((volatile uint8_t *)0xFD0) |= ((uint8_t)0x01 << BIT7)));
    switch(num){
        case INTERRUPT_EXTERNAL_INT1:
            if(priority==INTERRUPT_HIGH_LEVEL)
            (*((volatile uint8_t *)0xFF0) |= ((uint8_t)0x01 << BIT6));
            else if(priority==INTERRUPT_LOW_LEVEL)
            (*((volatile uint8_t *)0xFF0) &= ~((uint8_t)0x01 << BIT6));
            break;
        case INTERRUPT_EXTERNAL_INT2:
                if(priority==INTERRUPT_HIGH_LEVEL)
                (*((volatile uint8_t *)0xFF0) |= ((uint8_t)0x01 << BIT7));
                else if(priority==INTERRUPT_LOW_LEVEL)
                (*((volatile uint8_t *)0xFF0) &= ~((uint8_t)0x01 << BIT7));
                break;
    }
...
static Std_ReturnType INT0_SetInterruptHandler(void(*InterruptHandler)(void)){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if(((void*)0)==InterruptHandler)ret=(Std_ReturnType)0x00;
    else{
...
static Std_ReturnType Interrupt_INTx_SetInterruptHandler(INTx_NUM num,void(*add)(void)){
       Std_ReturnType ret =(Std_ReturnType)0x01;
    if(((void*)0)==add){ret=(Std_ReturnType)0x00;}
    else{
        switch(num){
            case INTERRUPT_EXTERNAL_INT0:
...
Std_ReturnType Interrupt_INTx(INTx_NUM num,INTx_edge edge,interrupt_priority priority,void(*ptr)(void)){
   ...
   Interrupt_INTx_Deinit(num);
        ...
        (*((volatile uint8_t *)0xFF2) &= ~((uint8_t)0x01 << BIT1)) ;
        (*((volatile uint8_t *)0xFF0) &= ~((uint8_t)0x01 << BIT0));
        (*((volatile uint8_t *)0xFF0) &= ~((uint8_t)0x01 << BIT1));
...
Std_ReturnType Interrupt_RBx(RBx_NUM num,interrupt_priority priority,void(*ptr0)(void),void(*ptr1)(void)){
    ...
    Std_ReturnType ret=(Std_ReturnType)0x01;
    ((*((volatile uint8_t *)0xFF2) &= ~((uint8_t)0x01 << BIT3)));
    (*((volatile uint8_t *)0xFF2) &= ~((uint8_t)0x01 << BIT0));
    ((*((volatile uint8_t *)0xFF2) |= ((uint8_t)0x01 << BIT7))) ; ((*((volatile uint8_t *)0xFF2) |= ((uint8_t)0x01 << BIT6)));
    if(((void*)0)!=ptr0){
        switch(num){
            case INTERRUPT_EXTERNAL_PIN4:
                dio_pin_direction_initialize(INTERRUPT_EXTERNAL_PIN4,'B',1);
                RB4_SetInterruptHandlerHigh(ptr0);
                if(((void*)0)==ptr1)RB4_SetInterruptHandlerLow(ptr0);
            ...
            case INTERRUPT_EXTERNAL_PIN5:
                ...
                if(((void*)0)==ptr1)RB5_SetInterruptHandlerLow(ptr0);
            ...
            case INTERRUPT_EXTERNAL_PIN6:
                ...
                if(((void*)0)==ptr1)RB6_SetInterruptHandlerLow(ptr0);
            ...
            case INTERRUPT_EXTERNAL_PIN7:
                ...
                if(((void*)0)==ptr1)RB7_SetInterruptHandlerLow(ptr0);
        ...
        if(priority==INTERRUPT_HIGH_LEVEL)
            ((*((volatile uint8_t *)0xFF1) &= ~((uint8_t)0x01 << BIT0)));
        else if(priority==INTERRUPT_LOW_LEVEL)
            ((*((volatile uint8_t *)0xFF1) |= ((uint8_t)0x01 << BIT0)));

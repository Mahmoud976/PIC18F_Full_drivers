# 1 "MCAL/Interrupt/Interrupt_Manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL/Interrupt/Interrupt_Manager.c" 2
...
# 1 "MCAL/Interrupt/Interrupt_Manager.h" 1
# 12 "MCAL/Interrupt/Interrupt_Manager.h"
# 1 "MCAL/Interrupt/External_Interrupt.h" 1
# 12 "MCAL/Interrupt/External_Interrupt.h"
# 1 "MCAL/Interrupt/Interrupt_cfg.h" 1
# 12 "MCAL/Interrupt/Interrupt_cfg.h"
# 1 "MCAL/Interrupt/../../Utilities/Registers/registers.h" 1
# 15 "MCAL/Interrupt/../../Utilities/Registers/registers.h"
# 1 "MCAL/Interrupt/../../Utilities/Registers/../types/types_t.h" 1
# 11 "MCAL/Interrupt/../../Utilities/Registers/../types/types_t.h"
# 1 "MCAL/Interrupt/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 1
# 10 "MCAL/Interrupt/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h"
...
# 10 "MCAL/Interrupt/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 2
# 11 "MCAL/Interrupt/../../Utilities/Registers/../types/types_t.h" 2

# 1 "MCAL/Interrupt/../../Utilities/Registers/../types/../std_Library/libraries.h" 1
# 10 "MCAL/Interrupt/../../Utilities/Registers/../types/../std_Library/libraries.h"
...
# 10 "MCAL/Interrupt/../../Utilities/Registers/../types/../std_Library/libraries.h" 2


# 1 "MCAL/Interrupt/../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 1
# 12 "MCAL/Interrupt/../../Utilities/Registers/../types/../std_Library/libraries.h" 2
# 12 "MCAL/Interrupt/../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 2
...
# 43 "MCAL/Interrupt/../../Utilities/Registers/../types/../std_Library/../types/types_t.h"
uint32_t _XTAL_FREQ=8000000;
# 15 "MCAL/Interrupt/../../Utilities/Registers/registers.h" 2
# 12 "MCAL/Interrupt/Interrupt_cfg.h" 2

# 1 "MCAL/Interrupt/../DIO_Driver/dio.h" 1
# 13 "MCAL/Interrupt/../DIO_Driver/dio.h"
# 1 "MCAL/Interrupt/../DIO_Driver/dio_cfg.h" 1
# 13 "MCAL/Interrupt/../DIO_Driver/dio.h" 2
# 46 "MCAL/Interrupt/../DIO_Driver/dio.h"
typedef enum{
    DIO_OUTPUT=0,
    DIO_INPUT
}direction_t;
...
# 13 "MCAL/Interrupt/Interrupt_cfg.h" 2
# 52 "MCAL/Interrupt/Interrupt_cfg.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY=0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority;
# 12 "MCAL/Interrupt/External_Interrupt.h" 2
# 41 "MCAL/Interrupt/External_Interrupt.h"
typedef enum{
    BIT0 =0,
    BIT1,
    BIT2,
...
void RB7_ISR_High();
void RB7_ISR_Low();
# 12 "MCAL/Interrupt/Interrupt_Manager.h" 2

# 1 "MCAL/Interrupt/Internal_Interrupt.h" 1
# 113 "MCAL/Interrupt/Internal_Interrupt.h"
typedef enum{
    LOW=0,
    HIGH
...
# 13 "MCAL/Interrupt/Interrupt_Manager.h" 2
# 9 "MCAL/Interrupt/Interrupt_Manager.c" 2




void __attribute__((picinterrupt(("")))) InterruptHigh(void){

    if(((*((volatile uint8_t *)0xF9E) >> BIT1)& (uint8_t)0x01))
        Timer2_ISR();


    if(((*((volatile uint8_t *)0xF9E) >> BIT0)& (uint8_t)0x01))
        Timer1_ISR();

    if(((*((volatile uint8_t *)0xFF2) >> BIT2)& (uint8_t)0x01))
        Timer0_ISR();

    if(((*((volatile uint8_t *)0xFF2) >> BIT1)& (uint8_t)0x01))
        INT0_ISR();


    if(((*((volatile uint8_t *)0xFF0) >> BIT1)& (uint8_t)0x01))
        INT2_ISR();

    if(((*((volatile uint8_t *)0xF9E) >> BIT6)& (uint8_t)0x01))
        ADC_ISR();
    ...
    if(((*((volatile uint8_t *)0xFF2) >> BIT0)& (uint8_t)0x01)&&(((*((volatile uint8_t *)0xF81) >> 5)& (uint8_t)0x01))==1)
        RB5_ISR_High();

    else if(((*((volatile uint8_t *)0xFF2) >> BIT0)& (uint8_t)0x01)&&(((*((volatile uint8_t *)0xF81) >> 5)& (uint8_t)0x01))==0)
        RB5_ISR_Low();

    if(((*((volatile uint8_t *)0xFF2) >> BIT0)& (uint8_t)0x01)&&(((*((volatile uint8_t *)0xF81) >> 6)& (uint8_t)0x01))==1)
        RB6_ISR_High();

    else if(((*((volatile uint8_t *)0xFF2) >> BIT0)& (uint8_t)0x01)&&(((*((volatile uint8_t *)0xF81) >> 6)& (uint8_t)0x01))==0)
        RB6_ISR_Low();

    if(((*((volatile uint8_t *)0xFF2) >> BIT0)& (uint8_t)0x01)&&(((*((volatile uint8_t *)0xF81) >> 7)& (uint8_t)0x01))==1)
        RB7_ISR_High();

    else if(((*((volatile uint8_t *)0xFF2) >> BIT0)& (uint8_t)0x01)&&(((*((volatile uint8_t *)0xF81) >> 7)& (uint8_t)0x01))==0)
        RB7_ISR_Low();


    else if(((*((volatile uint8_t *)0xF9D) >> BIT4)& (uint8_t)0x01))
        EUSART_TX_ISR();
    else if(((*((volatile uint8_t *)0xF9D) >> BIT5)& (uint8_t)0x01))
        EUSART_RX_ISR();

}
void __attribute__((picinterrupt(("low_priority")))) InterruptLow(void){
    ...
    if(((*((volatile uint8_t *)0xFF0) >> BIT0)& (uint8_t)0x01))
        INT1_ISR();




    if(((*((volatile uint8_t *)0xFF2) >> BIT0)& (uint8_t)0x01)&&(((*((volatile uint8_t *)0xF81) >> 4)& (uint8_t)0x01))==1)
        RB4_ISR_High();

    else if(((*((volatile uint8_t *)0xFF2) >> BIT0)& (uint8_t)0x01)&&(((*((volatile uint8_t *)0xF81) >> 4)& (uint8_t)0x01))==0)
        RB4_ISR_Low();

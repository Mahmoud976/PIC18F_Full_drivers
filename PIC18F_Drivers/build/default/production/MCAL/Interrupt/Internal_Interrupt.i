...
# 1 "MCAL/Interrupt/Internal_Interrupt.c" 2
 ...
 void (*ADC_InterruptHandler)(void)=((void*)0);
...
void Timer0_ISR(void){
   ...
   *((volatile uint8_t *)0xFD7)=(Timer0_Preload)>>8;
   *((volatile uint8_t *)0xFD6)=(uint8_t)(Timer0_Preload);
...
void Timer1_ISR(void){
   ...
   *((volatile uint8_t *)0xFCF)=(Timer1_Preload)>>8;
   *((volatile uint8_t *)0xFCE)=(uint8_t)(Timer1_Preload);
...
void Timer2_ISR(void){
   ...
   *((volatile uint8_t *)0xFCC)=Timer2_Preload;

    if(Timer2_InterruptHandler){Timer2_InterruptHandler();}

}
void Timer3_ISR(void){
   ((*((volatile uint8_t *)0xFA1) &= ~((uint8_t)0x01 << 1)));

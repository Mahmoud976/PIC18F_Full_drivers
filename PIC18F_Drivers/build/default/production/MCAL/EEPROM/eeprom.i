...
# 11 "MCAL/EEPROM/eeprom.h"
# 1 "MCAL/EEPROM/../../Utilities/Registers/registers.h" 1
# 15 "MCAL/EEPROM/../../Utilities/Registers/registers.h"
# 1 "MCAL/EEPROM/../../Utilities/Registers/../types/types_t.h" 1
# 11 "MCAL/EEPROM/../../Utilities/Registers/../types/types_t.h"
# 1 "MCAL/EEPROM/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 1
# 10 "MCAL/EEPROM/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h"
...
# 10 "MCAL/EEPROM/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 2
# 11 "MCAL/EEPROM/../../Utilities/Registers/../types/types_t.h" 2

# 1 "MCAL/EEPROM/../../Utilities/Registers/../types/../std_Library/libraries.h" 1
# 10 "MCAL/EEPROM/../../Utilities/Registers/../types/../std_Library/libraries.h"
...
# 10 "MCAL/EEPROM/../../Utilities/Registers/../types/../std_Library/libraries.h" 2


# 1 "MCAL/EEPROM/../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 1
# 12 "MCAL/EEPROM/../../Utilities/Registers/../types/../std_Library/libraries.h" 2
# 12 "MCAL/EEPROM/../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 2
...
# 43 "MCAL/EEPROM/../../Utilities/Registers/../types/../std_Library/../types/types_t.h"
uint32_t _XTAL_FREQ=8000000;
# 15 "MCAL/EEPROM/../../Utilities/Registers/registers.h" 2
# 11 "MCAL/EEPROM/eeprom.h" 2
# 29 "MCAL/EEPROM/eeprom.h"
...
Std_ReturnType Data_EEPROM_WriteByte(uint16_t bAdd,uint8_t bData){
    ...
    Std_ReturnType Global_Interrupt_Status=((*((volatile uint8_t *)0xFF2) >> 7)& (uint8_t)0x01);

    *((volatile uint8_t *)0xFAA)=(uint8_t)((bAdd>>8)&0x03);
    *((volatile uint8_t *)0xFA9)=(uint8_t)(bAdd & 0xFF);

    *((volatile uint8_t *)0xFA8)=bData;

    (*((volatile uint8_t *)0xFA6) &= ~((uint8_t)0x01 << 7));
    (*((volatile uint8_t *)0xFA6) &= ~((uint8_t)0x01 << 6));

    (*((volatile uint8_t *)0xFA6) |= ((uint8_t)0x01 << 2));

    (*((volatile uint8_t *)0xFF2) &= ~((uint8_t)0x01 << 7));

    *((volatile uint8_t *)0xFA7)=0x55;
    *((volatile uint8_t *)0xFA7)=0xAA;

    (*((volatile uint8_t *)0xFA6) |= ((uint8_t)0x01 << 1));

    while(((*((volatile uint8_t *)0xFA6) >> 1)& (uint8_t)0x01));

    (*((volatile uint8_t *)0xFA6) &= ~((uint8_t)0x01 << 2));

    if(Global_Interrupt_Status==1)(*((volatile uint8_t *)0xFF2) |= ((uint8_t)0x01 << 7));
    return ret;
}
Std_ReturnType Data_EEPROM_Read_Byte(uint16_t bAdd,uint8_t *bData){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if(((void*)0)==bData) ret=(Std_ReturnType)0x00;
    else{

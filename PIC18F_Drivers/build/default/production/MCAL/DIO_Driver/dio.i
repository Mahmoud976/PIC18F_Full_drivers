...
# 2 "<built-in>" 2
# 1 "MCAL/DIO_Driver/dio.c" 2
# 1 "MCAL/DIO_Driver/dio.h" 1
# 12 "MCAL/DIO_Driver/dio.h"
# 1 "MCAL/DIO_Driver/../../Utilities/Registers/registers.h" 1
# 15 "MCAL/DIO_Driver/../../Utilities/Registers/registers.h"
# 1 "MCAL/DIO_Driver/../../Utilities/Registers/../types/types_t.h" 1
# 11 "MCAL/DIO_Driver/../../Utilities/Registers/../types/types_t.h"
# 1 "MCAL/DIO_Driver/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 1
# 10 "MCAL/DIO_Driver/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h"
...
# 10 "MCAL/DIO_Driver/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 2
# 11 "MCAL/DIO_Driver/../../Utilities/Registers/../types/types_t.h" 2

# 1 "MCAL/DIO_Driver/../../Utilities/Registers/../types/../std_Library/libraries.h" 1
# 10 "MCAL/DIO_Driver/../../Utilities/Registers/../types/../std_Library/libraries.h"
...
# 10 "MCAL/DIO_Driver/../../Utilities/Registers/../types/../std_Library/libraries.h" 2


# 1 "MCAL/DIO_Driver/../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 1
# 12 "MCAL/DIO_Driver/../../Utilities/Registers/../types/../std_Library/libraries.h" 2
# 12 "MCAL/DIO_Driver/../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 2
...
# 43 "MCAL/DIO_Driver/../../Utilities/Registers/../types/../std_Library/../types/types_t.h"
uint32_t _XTAL_FREQ=8000000;
# 15 "MCAL/DIO_Driver/../../Utilities/Registers/registers.h" 2
# 12 "MCAL/DIO_Driver/dio.h" 2

# 1 "MCAL/DIO_Driver/dio_cfg.h" 1
# 13 "MCAL/DIO_Driver/dio.h" 2
# 46 "MCAL/DIO_Driver/dio.h"
typedef enum{
    DIO_OUTPUT=0,
    DIO_INPUT
}direction_t;
...
Std_ReturnType dio_pin_direction_initialize(uint8_t pinNum,uint8_t port,uint8_t direction){
    uint8_t ret=(Std_ReturnType)0x01;
    if(pinNum > 7)ret=(Std_ReturnType)0x00;
    else{
        switch(port){
            case 'A':
               if(direction == DIO_OUTPUT) (*((volatile uint8_t *)0xF92) &= ~((uint8_t)0x01 << pinNum));
               else if(direction == DIO_INPUT) (*((volatile uint8_t *)0xF92) |= ((uint8_t)0x01 << pinNum));
               else ret=(Std_ReturnType)0x00;
               break;
            case 'B':
               if(direction == DIO_OUTPUT) (*((volatile uint8_t *)0xF93) &= ~((uint8_t)0x01 << pinNum));
               else if(direction == DIO_INPUT) (*((volatile uint8_t *)0xF93) |= ((uint8_t)0x01 << pinNum));
               else ret=(Std_ReturnType)0x00;
               break;
            case 'C':
               if(direction == DIO_OUTPUT) (*((volatile uint8_t *)0xF94) &= ~((uint8_t)0x01 << pinNum));
               else if(direction == DIO_INPUT) (*((volatile uint8_t *)0xF94) |= ((uint8_t)0x01 << pinNum));
               else ret=(Std_ReturnType)0x00;
               break;
            case 'D':
               if(direction == DIO_OUTPUT) (*((volatile uint8_t *)0xF95) &= ~((uint8_t)0x01 << pinNum));
               else if(direction == DIO_INPUT) (*((volatile uint8_t *)0xF95) |= ((uint8_t)0x01 << pinNum));
               else ret=(Std_ReturnType)0x00;
               break;
            case 'E':
               if(direction == DIO_OUTPUT) (*((volatile uint8_t *)0xF96) &= ~((uint8_t)0x01 << pinNum));
               else if(direction == DIO_INPUT) (*((volatile uint8_t *)0xF96) |= ((uint8_t)0x01 << pinNum));
               else ret=(Std_ReturnType)0x00;
            default :
...
Std_ReturnType dio_pin_write_logic( uint8_t pinNum ,uint8_t port ,logic_t logic){
    ...
    if(pinNum > 7)ret=(Std_ReturnType)0x00;
        ...
        switch(port){
            case 'A':
               if(logic == DIO_LOW) (*((volatile uint8_t *)0xF89) &= ~((uint8_t)0x01 << pinNum));
               else if(logic == DIO_HIGH) (*((volatile uint8_t *)0xF89) |= ((uint8_t)0x01 << pinNum));
               else ret=(Std_ReturnType)0x00;
               break;
            case 'B':
               if(logic == DIO_LOW) (*((volatile uint8_t *)0xF8A) &= ~((uint8_t)0x01 << pinNum));
               else if(logic == DIO_HIGH) (*((volatile uint8_t *)0xF8A) |= ((uint8_t)0x01 << pinNum));
               else ret=(Std_ReturnType)0x00;
               break;
            case 'C':
               if(logic == DIO_LOW) (*((volatile uint8_t *)0xF8B) &= ~((uint8_t)0x01 << pinNum));
               else if(logic == DIO_HIGH) (*((volatile uint8_t *)0xF8B) |= ((uint8_t)0x01 << pinNum));
               else ret=(Std_ReturnType)0x00;
               break;
            case 'D':
               if(logic == DIO_LOW) (*((volatile uint8_t *)0xF8C) &= ~((uint8_t)0x01 << pinNum));
               else if(logic == DIO_HIGH) (*((volatile uint8_t *)0xF8C) |= ((uint8_t)0x01 << pinNum));
               else ret=(Std_ReturnType)0x00;
               break;
            case 'E':
               if(logic == DIO_LOW) (*((volatile uint8_t *)0xF8D) &= ~((uint8_t)0x01 << pinNum));
               else if(logic == DIO_HIGH) (*((volatile uint8_t *)0xF8D) |= ((uint8_t)0x01 << pinNum));
               else ret=(Std_ReturnType)0x00;
               break;
            default :
               ret=(Std_ReturnType)0x00;
...
Std_ReturnType dio_pin_read_logic(uint8_t pinNum,uint8_t port,logic_t * logic_status){
    uint8_t ret=(Std_ReturnType)0x01;
    if(7 < pinNum || ((void*)0)==logic_status)ret=(Std_ReturnType)0x00;
    else{
        switch(port){
            case 'A':
               * logic_status = ((*((volatile uint8_t *)0xF80) >> pinNum)& (uint8_t)0x01);
               break;
            case 'B':
               * logic_status = ((*((volatile uint8_t *)0xF81) >> pinNum)& (uint8_t)0x01);
               break;
            case 'C':
               * logic_status = ((*((volatile uint8_t *)0xF82) >> pinNum)& (uint8_t)0x01);
               break;
            case 'D':
               * logic_status = ((*((volatile uint8_t *)0xF83) >> pinNum)& (uint8_t)0x01);
               break;
            case 'E':
               * logic_status = ((*((volatile uint8_t *)0xF84) >> pinNum)& (uint8_t)0x01);
               break;
            default :
               ret=(Std_ReturnType)0x00;
        }
...
Std_ReturnType dio_pin_toggle_logic(uint8_t pinNum,uint8_t port){
   uint8_t ret=(Std_ReturnType)0x01;
    if(pinNum > 7)ret=(Std_ReturnType)0x00;
        ...
        switch(port){
            case 'A':
               (*((volatile uint8_t *)0xF89) ^= ((uint8_t)0x01 << pinNum));
               break;
            case 'B':
               (*((volatile uint8_t *)0xF8A) ^= ((uint8_t)0x01 << pinNum));
               break;
            case 'C':
               (*((volatile uint8_t *)0xF8B) ^= ((uint8_t)0x01 << pinNum));
               break;
            case 'D':
               (*((volatile uint8_t *)0xF8C) ^= ((uint8_t)0x01 << pinNum));
               break;
            case 'E':
               (*((volatile uint8_t *)0xF8D) ^= ((uint8_t)0x01 << pinNum));
               break;
            default :
               ret=(Std_ReturnType)0x00;
        }
...
Std_ReturnType dio_port_direction_initialize(uint8_t port,uint8_t direction){
    ...
    switch(port){
        case 'A':
            if(direction == DIO_OUTPUT) (*((volatile uint8_t *)0xF92)&=((uint8_t)0x00));
            else if(direction == DIO_INPUT) (*((volatile uint8_t *)0xF92)|=(uint8_t)0xFF);
            else ret=(Std_ReturnType)0x00;
            break;
        case 'B':
            if(direction == DIO_OUTPUT) (*((volatile uint8_t *)0xF93)&=((uint8_t)0x00));
            else if(direction == DIO_INPUT) (*((volatile uint8_t *)0xF93)|=(uint8_t)0xFF);
            else ret=(Std_ReturnType)0x00;
            break;
        case 'C':
            if(direction == DIO_OUTPUT) (*((volatile uint8_t *)0xF94)&=((uint8_t)0x00));
            else if(direction == DIO_INPUT) (*((volatile uint8_t *)0xF94)|=(uint8_t)0xFF);
            else ret=(Std_ReturnType)0x00;
            break;
        case 'D':
            if(direction == DIO_OUTPUT) (*((volatile uint8_t *)0xF95)&=((uint8_t)0x00));
            else if(direction == DIO_INPUT) (*((volatile uint8_t *)0xF95)|=(uint8_t)0xFF);
            else ret=(Std_ReturnType)0x00;
            break;
        case 'E':
            if(direction == DIO_OUTPUT) (*((volatile uint8_t *)0xF96)&=((uint8_t)0x00));
            else if(direction == DIO_INPUT) (*((volatile uint8_t *)0xF96)|=(uint8_t)0xFF);
            else ret=(Std_ReturnType)0x00;
            break;
        default :
            ret=(Std_ReturnType)0x00;
...
Std_ReturnType dio_port_write_logic(uint8_t port,logic_t logic){
    ...
    switch(port){
        case 'A':
           if(logic == DIO_LOW) (*((volatile uint8_t *)0xF89)&=(uint8_t)0x00);
           else if(logic == DIO_HIGH) (*((volatile uint8_t *)0xF89)|=(uint8_t)0xFF);
           else ret=(Std_ReturnType)0x00;
           break;
        case 'B':
           if(logic == DIO_LOW) (*((volatile uint8_t *)0xF8A)&=(uint8_t)0x00);
           else if(logic == DIO_HIGH) (*((volatile uint8_t *)0xF8A)|=(uint8_t)0xFF);
           else ret=(Std_ReturnType)0x00;
           break;
        case 'C':
           if(logic == DIO_LOW) (*((volatile uint8_t *)0xF8B)&=(uint8_t)0x00);
           else if(logic == DIO_HIGH) (*((volatile uint8_t *)0xF8B)|=(uint8_t)0xFF);
           else ret=(Std_ReturnType)0x00;
           break;
        case 'D':
           if(logic == DIO_LOW) (*((volatile uint8_t *)0xF8C)&=(uint8_t)0x00);
           else if(logic == DIO_HIGH) (*((volatile uint8_t *)0xF8C)|=(uint8_t)0xFF);
           else ret=(Std_ReturnType)0x00;
           break;
        case 'E':
           if(logic == DIO_LOW) (*((volatile uint8_t *)0xF8D)&=(uint8_t)0x00);
           else if(logic == DIO_HIGH) (*((volatile uint8_t *)0xF8D)|=(uint8_t)0xFF);
           else ret=(Std_ReturnType)0x00;
           break;
        default :
           ret=(Std_ReturnType)0x00;
...
Std_ReturnType dio_port_read_logic(uint8_t port,logic_t* logic_status){
    uint8_t ret=(Std_ReturnType)0x01;
    if(((void*)0)==logic_status)ret=(Std_ReturnType)0x00;
    else{
        switch(port){
            case 'A':
               * logic_status =(*((volatile uint8_t *)0xF80) &= (uint8_t)0xFF);
               break;
            case 'B':
               * logic_status = (*((volatile uint8_t *)0xF81) &= (uint8_t)0xFF);
               break;
            case 'C':
               * logic_status = (*((volatile uint8_t *)0xF82) &= (uint8_t)0xFF);
               break;
            case 'D':
               * logic_status = (*((volatile uint8_t *)0xF83) &= (uint8_t)0xFF);
               break;
            case 'E':
               * logic_status = (*((volatile uint8_t *)0xF84) &= (uint8_t)0xFF);
               break;
            default :
               ret=(Std_ReturnType)0x00;
        }
...
Std_ReturnType dio_port_toggle_logic(uint8_t port){
    ...
    switch(port){
        case 'A':
           (*((volatile uint8_t *)0xF89) ^=(uint8_t)0xFF);
           break;
        case 'B':
           (*((volatile uint8_t *)0xF8A) ^= (uint8_t)0xFF);
           break;
        case 'C':
           (*((volatile uint8_t *)0xF8B) ^= (uint8_t)0xFF);
           break;
        case 'D':
           (*((volatile uint8_t *)0xF8C) ^= (uint8_t)0xFF);
           break;
        case 'E':
           (*((volatile uint8_t *)0xF8D) ^= (uint8_t)0xFF);
           break;
        default :
           ret=(Std_ReturnType)0x00;
    }

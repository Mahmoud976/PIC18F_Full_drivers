...
# 2 "<built-in>" 2
# 1 "MCAL/EUSART/eusart.c" 2
# 1 "MCAL/EUSART/eusart.h" 1
# 12 "MCAL/EUSART/eusart.h"
# 1 "MCAL/EUSART/eusart_cfg.h" 1
# 12 "MCAL/EUSART/eusart.h" 2

# 1 "MCAL/EUSART/../../Utilities/Registers/registers.h" 1
# 15 "MCAL/EUSART/../../Utilities/Registers/registers.h"
# 1 "MCAL/EUSART/../../Utilities/Registers/../types/types_t.h" 1
# 11 "MCAL/EUSART/../../Utilities/Registers/../types/types_t.h"
# 1 "MCAL/EUSART/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 1
# 10 "MCAL/EUSART/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h"
...
# 10 "MCAL/EUSART/../../Utilities/Registers/../types/../DEV_CONFIG/dev_config.h" 2
# 11 "MCAL/EUSART/../../Utilities/Registers/../types/types_t.h" 2

# 1 "MCAL/EUSART/../../Utilities/Registers/../types/../std_Library/libraries.h" 1
# 10 "MCAL/EUSART/../../Utilities/Registers/../types/../std_Library/libraries.h"
...
# 10 "MCAL/EUSART/../../Utilities/Registers/../types/../std_Library/libraries.h" 2


# 1 "MCAL/EUSART/../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 1
# 12 "MCAL/EUSART/../../Utilities/Registers/../types/../std_Library/libraries.h" 2
# 12 "MCAL/EUSART/../../Utilities/Registers/../types/../std_Library/../types/types_t.h" 2
...
# 43 "MCAL/EUSART/../../Utilities/Registers/../types/../std_Library/../types/types_t.h"
uint32_t _XTAL_FREQ=8000000;
# 15 "MCAL/EUSART/../../Utilities/Registers/registers.h" 2
# 13 "MCAL/EUSART/eusart.h" 2

# 1 "MCAL/EUSART/../Interrupt/Internal_Interrupt.h" 1
# 12 "MCAL/EUSART/../Interrupt/Internal_Interrupt.h"
# 1 "MCAL/EUSART/../Interrupt/Interrupt_cfg.h" 1
# 13 "MCAL/EUSART/../Interrupt/Interrupt_cfg.h"
# 1 "MCAL/EUSART/../Interrupt/../DIO_Driver/dio.h" 1
# 13 "MCAL/EUSART/../Interrupt/../DIO_Driver/dio.h"
# 1 "MCAL/EUSART/../Interrupt/../DIO_Driver/dio_cfg.h" 1
# 13 "MCAL/EUSART/../Interrupt/../DIO_Driver/dio.h" 2
# 46 "MCAL/EUSART/../Interrupt/../DIO_Driver/dio.h"
typedef enum{
    DIO_OUTPUT=0,
    DIO_INPUT
}direction_t;
...
# 13 "MCAL/EUSART/../Interrupt/Interrupt_cfg.h" 2
# 52 "MCAL/EUSART/../Interrupt/Interrupt_cfg.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY=0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority;
# 12 "MCAL/EUSART/../Interrupt/Internal_Interrupt.h" 2
# 113 "MCAL/EUSART/../Interrupt/Internal_Interrupt.h"
typedef enum{
    LOW=0,
    HIGH
...
# 14 "MCAL/EUSART/eusart.h" 2
# 60 "MCAL/EUSART/eusart.h"
typedef enum{
...
Std_ReturnType EUSART_ASYNC_WriteByte(uint8_t _data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
# 70 "MCAL/EUSART/eusart.c"
    ((*((volatile uint8_t *)0xFF2) |= ((uint8_t)0x01 << 7)));
    if(TXSTAbits.TRMT){

            ((*((volatile uint8_t *)0xF9D) &= ~((uint8_t)0x01 << 4)));

            *((volatile uint8_t *)0xFAD) = _data;
            ret=(Std_ReturnType)0x01;
    }
    else { }
...
static void EUSART_Baud_Rate_Calculation(const usart_t *_eusart){
    ...
    *((volatile uint8_t *)0xFAF) = (uint8_t)((uint32_t)Baud_Rate_Temp);
    *((volatile uint8_t *)0xFB0) = (uint8_t)(((uint32_t)Baud_Rate_Temp) >> 8);
}
static void EUSART_ASYNC_TX_Init(const usart_t *_eusart){
    if(1 == _eusart->usart_tx_cfg.usart_tx_enable){
        ...
        if(INTERRUPT_HIGH_PRIORITY == _eusart->usart_tx_cfg.usart_tx_int_priority){
            ((*((volatile uint8_t *)0xF9F) |= ((uint8_t)0x01 << 4)));
        }
...
static void EUSART_ASYNC_RX_Init(const usart_t *_eusart){
    if(1 == _eusart->usart_rx_cfg.usart_rx_enable){
        ...
        ((*((volatile uint8_t *)0xFF2) |= ((uint8_t)0x01 << 7)));
        ((*((volatile uint8_t *)0xF9D) |= ((uint8_t)0x01 << 5)));
        ...
        if(INTERRUPT_HIGH_PRIORITY == _eusart->usart_rx_cfg.usart_rx_int_priority){
            ((*((volatile uint8_t *)0xF9F) |= ((uint8_t)0x01 << 5)));
        }
